...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: TYeGnnCG6iTC/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: e_OoaHy7lLOh/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__iwwU)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__bzA5)}
              />
            </React.Fragment>
          ),
          value: args.children
